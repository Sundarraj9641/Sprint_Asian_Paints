...
public class Samarth_Interior
{
	...
	public void userClicksInteriorTexturesTab() 
	{
		...
		Samarth_Browser.interiorPgObj.interior();
	}
	...
	public void interiorTexturePageIsDisplayed() 
	{
		...
		boolean isinteriorPageDisplayed = Samarth_Browser.interiorPgObj.interiorPage.isDisplayed();
	...
	public void userClicksOnTheInteriorTexturesProduct() 
	{
		...
		Samarth_Browser.interiorPgObj.interiorProd();
	}
