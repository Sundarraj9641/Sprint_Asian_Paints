...
public class Samrudhi_Findacontractor {
	...
	public void userClicsOnFindAContractorIcon() throws InterruptedException
	{
		...
		Samrudhi_Browser.conPgObj.contractorIcon();
		Thread.sleep(2000);
	}
	...
	public void userEntersPinCode(String pin) throws InterruptedException 
	{
		...
		Samrudhi_Browser.conPgObj.enterPinCode(pin);
		Thread.sleep(2000);
	}
	...
	public void userClicksSearchButton()throws InterruptedException 
	{
		...
		Samrudhi_Browser.conPgObj.contractorSubmit();
		Thread.sleep(2000);
	}
	...
	public void contractorPageIsDisplayed()throws InterruptedException 
	{
		...
		boolean isContractorPageDisplayed = Samrudhi_Browser.conPgObj.contractorPage.isDisplayed();
		assertTrue(isContractorPageDisplayed);
		Samrudhi_Browser.conPgObj.contractorClear();
		Thread.sleep(2000);
	}
	...
	public void unsuccesfulPinErrorMessageIsDisplayed()throws InterruptedException 
	{
		...
		System.out.println(Samrudhi_Browser.conPgObj.contractorErrorMsg());
		boolean isEnquirePinCodeDisplayed = Samrudhi_Browser.conPgObj.contractorErrorMsg.isDisplayed();
	...
	public void errorMessageMustBeEnterAValidDigitZipCode(String expectedMsg) {
	    String actualMsg= Samrudhi_Browser.conPgObj.contractorErrorMsg.getText();
