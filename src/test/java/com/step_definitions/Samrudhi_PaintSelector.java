...
public class Samrudhi_PaintSelector 
{
	...
	public void userClicksPaintSelectorTab() 
	{
		...
		Samrudhi_Browser.paintSelectorgObj.painSelector();
	}
	...
	public void userIsOnPaintSelectorPage() 
	{
		...
		boolean isPaintSelectPageDisplayed = Samrudhi_Browser.paintSelectorgObj.paint_Select_page.isDisplayed();
	...
	public void paintSelectorProductPageIsDisplayed()
	{
		...
		Samrudhi_Browser.paintSelectorgObj.paintSelectorProduct();
	}
