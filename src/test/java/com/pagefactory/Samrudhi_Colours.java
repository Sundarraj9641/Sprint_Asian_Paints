...
public class Samrudhi_Colours 
{
	...
	//Colours_2200 Tab
	@FindBy(xpath="//*[@id=\"ColoursTextures\"]/li[1]/a")
	@CacheLookup
	...
	@FindBy(xpath="(//input[@class='form-global__field form-text-input__field commonTextComp'])[7]")
	@CacheLookup
	static WebElement form_Mobile;

	//Pin Code Text Box
	@FindBy(xpath="(//input[@class='js-enquirePinCodeCheck form-global__field form-text-input__field commonTextComp'])[2]")
	@CacheLookup
	static WebElement form_Pincode;

	//Enquire Now submission button
	@FindBy(xpath="(//button[@class='ctaText enquireForm--step-1-submit track_form_submit'])[2]")
	@CacheLookup
